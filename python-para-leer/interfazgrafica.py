...
class MainWin:
    ...
    def __init__(self):
        ...
        main_win.set_title("Cryptografia_para_subir_archivos_de_la_que tarda")
        ...
        self.label2 = gtk.Label("Pon la ruta de tu archivo")
        self.entry = gtk.Entry()
        #self.entry.connect("activate", self.on_button1.clicked)
        ...
        self.label = gtk.Label("Encryptar")
        #self.entry = gtk.Entry()
        ...
        button2.connect("clicked", self.on_button1_clicked)
    ...
    def on_button1_clicked(self, widget):
        ...
        self.label.set_text("Preva %s" % texto)
